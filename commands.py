...
async def help_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "help_examples":
        text = (
            ...
            "🛕 *Башня*\n"
            "`/tower 3 500` — 3 сложность, ставка $500\n"
            "`/tower 2 1k` — 2 сложность, ставка $1000\n"
            "`/tower 5 all` — 5 сложность, все деньги\n"
            "__Чем больше сложность, тем больше шанс попасться, но больше коэффициент при победе__\n\n"
            "⚔️ *Дуэли*\n"
