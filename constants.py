...
TALENT_BONUSES = {
    "untouchable": -0.1,  # -0.1% защита от кражи за уровень
...
# ======================= ВКЛАДЫ =======================
# Формат: "ключ": (сумма, множитель, часы)
# Снижены мультипликаторы и увеличены сроки, чтобы вклады были "сейфом", а не лучшим фармом.

DEPOSITS = {
    "deposit_1": (10_000, 1.15, 6),  # +15% за 6 часов
    "deposit_2": (100_000, 1.20, 12),  # +20% за 12 часов
    "deposit_3": (1_000_000, 1.30, 24),  # +30% за 24 часа
    "deposit_4": (10_000_000, 1.40, 48),  # +40% за 48 часов
    "deposit_5": (100_000_000, 1.60, 96),  # +60% за 96 часов
}

# ======================= КРАЖА =======================

STEAL = {
    "min_target_balance": 10,  # Минимальный баланс жертвы
...
HACK = {
    ...
    "max_amount": 150000,  # Максимальная сумма взлома
    "tiers": [
        (15, 25000, 175000),  # 15% шанс: $10k-$150k
        (45, 5000, 25000),  # 30% шанс: $5k-$10k (45-15=30)
...
BUSINESS_LIST = [
    ...
    },
    {
        ...
        "lvl": 18,
        "mastery": 26,
        "bonus": "+5% шанс к /steal",
        "user_bonus": {"steal_luck_chance": 5}
    },
    {
        "id": 10,
    ...
    # {
    #     "id": "11", # Например, 2.5, или следующий уникальный номер по порядку
    #     "name": "Кальянная",
    #     "emoji": "💨",
    #     "price": 750_000,
    #     "income": 12_500,
    #     "lvl": 4,
    #     "mastery": 10,
    #     "bonus": "+10% к шансу успеха /steal",
    #     "user_bonus": {"steal_success_chance": 0.1} # Примерное название ключа
    # },
]
